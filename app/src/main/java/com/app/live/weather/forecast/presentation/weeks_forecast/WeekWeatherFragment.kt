...
class WeekWeatherFragment: BaseFragment<FragmentWeekWeatherBinding, ForecastViewModel>() {
    override val viewModel: ForecastViewModel by viewModel()

    override fun inflateBinding(
        inflater: LayoutInflater,
        container: ViewGroup?
    ) = FragmentWeekWeatherBinding.inflate(inflater, container, false)
    ...
    private fun initUi() {
        ...
        viewModel.forecast.observe(viewLifecycleOwner) { forecast ->
            ...
            adapter.submitList(listForecast)
        }
